...
export default function AuthClient() {
  ...
  // React to query param changes (Next.js does not remount the page when only searchParams change).
  useEffect(() => {
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-6">
            ...
            <div className="mt-5 space-y-3">
              ...
              <button
                onClick={submit}
                disabled={busy}
                className="w-full bg-blue-600 hover:bg-blue-500 text-white rounded-lg py-2.5 font-medium disabled:opacity-60"
              >
